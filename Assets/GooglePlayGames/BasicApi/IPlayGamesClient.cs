...
namespace GooglePlayGames.BasicApi
{
    ...
    ///         <see cref="PlayGamesHelperObject.RunOnGameThread(System.Action)" />).
    ///     </para>
    /// </remarks>
    public interface IPlayGamesClient
    {
        ...
        /// </summary>
        /// <returns>
        ///     The user's human-readable name. <code>null</code> if they are not logged
        ///     in
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     The URL to load the avatar image. <code>null</code> if they are not logged
        ///     in
        /// </returns>
        ...
        /// <param name="successOrFailureCalllback">
        ...
        /// </summary>
        /// <remarks>
        ///     If the passed ID is <code>null</code>, all leaderboards are displayed.
        /// </remarks>
        /// <param name="leaderboardId">
        ///     The leaderboard to display. <code>null</code> to display
        ///     all.
        /// </param>
