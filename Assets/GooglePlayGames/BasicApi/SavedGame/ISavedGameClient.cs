...
namespace GooglePlayGames.BasicApi.SavedGame
{
    ...
    ///     <para>
    ///         <strong>Filenames</strong> - act as unique identifiers for saved games. Two devices
    ...
    ///     </para>
    ///     <para>
    ///         <strong>Saved Game Metadata</strong> are represented by <see cref="ISavedGameMetadata" />.
    ...
    ///     </para>
    ///     <para>
    ///         <strong>Conflicts</strong> occur when multiple devices attempt to write to the same file
    ...
    ///     <para>
    ///         See online
    ///         <a href="https://developers.google.com/games/services/common/concepts/savedgames">
    ///             documentation for Saved Games
    ///         </a>
    ...
    public interface ISavedGameClient
    {
        ...
        /// </param>
        /// <param name="source">
        ///     The data source to use. <see cref="DataSource" /> for a description
        ...
        ///     <see cref="ConflictResolutionStrategy" /> for a description of these strategies.
        /// </param>
        /// <param name="callback">
        ...
        ///     of the available options here.
        /// </param>
        /// <param name="prefetchDataOnConflict">
        ///     If set to <c>true</c>, the data for the two
        ...
        ///     read completed without error, the passed status will be <see cref="SavedGameRequestStatus.Success" /> and the
        ///     passed
        ...
        /// <param name="maxDisplayedSavedGames">
        ///     The maximum number of saved games the UI may display.
        ///     This value must be greater than 0.
        /// </param>
        /// <param name="showCreateSaveUI">
        ///     If set to <c>true</c>, show UI that will allow the user to
        ///     create a new saved game.
        /// </param>
        /// <param name="showDeleteSaveUI">
        ///     If set to <c>true</c> show UI that will allow the user to
        ///     delete a saved game.
        /// </param>
        /// <param name="callback">
        ...
        ///     method will immediately fail with status <see cref="SelectUIStatus.BadInputError" />
        /// </param>
        /// <param name="updateForMetadata">
    ...
    public interface IConflictResolver
    {
        ...
        ///     ConflictResolver will immediately fail with <see cref="SelectUIStatus.BadInputError" />.
        /// </param>
