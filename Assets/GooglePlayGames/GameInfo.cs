...
namespace GooglePlayGames
{
    ...
    {
        const string UnescapedApplicationId = "APP_ID";
        const string UnescapedIosClientId = "IOS_CLIENTID";
        const string UnescapedWebClientId = "WEB_CLIENTID";
        const string UnescapedNearbyServiceId = "NEARBY_SERVICE_ID";

        public const string ApplicationId = "501089576983"; // Filled in automatically
        ...
        static string ToEscapedToken(string token)
        {
