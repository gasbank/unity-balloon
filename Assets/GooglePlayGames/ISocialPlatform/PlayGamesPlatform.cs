...
namespace GooglePlayGames
{
    ...
    public class PlayGamesPlatform : ISocialPlatform
    {
        ...
        static volatile PlayGamesPlatform sInstance;

        /// <summary>status of nearby connection initialization.</summary>
        static volatile bool sNearbyInitializePending;
        ...
        static volatile INearbyConnectionClient sNearbyConnectionClient;
        ...
        readonly Dictionary<string, string> mIdMap = new Dictionary<string, string>();

        /// <summary>The local user.</summary>
        PlayGamesLocalUser mLocalUser;
        ...
        PlayGamesPlatform(PlayGamesClientConfiguration configuration)
        {
                ...
                for (var i = 0; i < ach.Length; i++)
                    if (ach[i].Id == achievementID)
                    {
                        if (ach[i].IsIncremental)
                        {
                            ...
                            mClient.SetStepsAtLeast(achievementID, progressToSteps(progress, ach[i].TotalSteps),
                                callback);
                        }
                        else
                        {
        ...
        public void LoadAchievementDescriptions(Action<IAchievementDescription[]> callback)
        {
            ...
            mClient.LoadAchievements(ach =>
            {
                ...
                for (var i = 0; i < data.Length; i++) data[i] = new PlayGamesAchievement(ach[i]);
        ...
        public void LoadScores(ILeaderboard board, Action<bool> callback)
        {
            ...
            Logger.d("LoadScores, board=" + board +
        ...
        public static void InitializeNearby(Action<INearbyConnectionClient> callback)
        {
            ...
            if (sNearbyConnectionClient == null)
            {
                ...
                if (callback != null) callback.Invoke(sNearbyConnectionClient);
        ...
        {
            Authenticate((success, msg) => callback(success), silent);
        }
        ...
        /// <param name="signInInteractivity">
        ///     <see cref="SignInInteractivity" />
        /// </param>
            ...
            switch (signInInteractivity)
            {
                ...
                case SignInInteractivity.CanPromptOnce:
                    ...
                    mClient.Authenticate( /* silent= */ true, silentSignInResultCode =>
                    {
                        ...
                        {
                            Logger.d("Successful, triggering callback");
                        ...
                        mClient.Authenticate( /* silent= */ false, interactiveSignInResultCode =>
                        {
                            ...
                            {
                                Logger.d("Cancelled, saving this to a shared pref");
        ...
        /// <summary>
        ///     Sign out. After signing out,
        ///     Authenticate must be called again to sign back in.
        /// </summary>
        public void SignOut()
        {
            if (mClient != null) mClient.SignOut();
        ...
        {
            if (mClient != null) return mClient.GetIdToken();
        ...
        /// </summary>
        /// <remarks>
        ///     This code is used by the server application in order to get
        ...
        {
            if (mClient != null && mClient.IsAuthenticated()) return mClient.GetServerAuthCode();
        ...
        /// </param>
        /// <param name="callback">
        ///     Callback returning the auth code or null
        ///     if there was an error.  NOTE: This callback can return immediately.
        /// </param>
            ...
            Action<string> callback)
        {
            ...
            else if (mClient != null && reAuthenticateIfNeeded)
            {
                mClient.Authenticate(false, status =>
                {
                    ...
                    {
                        Logger.e("Re-authentication failed: " + status);
                        callback(null);
                    }
                });
            }
        ...
        public void ReportScore(long score, string board, string metadata, Action<bool> callback)
        {
            ...
            Logger.d("ReportScore: score=" + score +
                     ", board=" + board +
                     " metadata=" + metadata);
            var leaderboardId = MapId(board);
            ...
            Action<UIStatus> callback)
        {
            if (!IsAuthenticated())
            {
                ...
                if (callback != null) callback(UIStatus.NotAuthorized);

                return;
            }

            Logger.d("ShowLeaderboardUI, lbId=" +
        ...
        {
            RequestPermissions(new[] {scope}, callback);
        }
        ...
        {
            return HasPermissions(new[] {scope});
        }
