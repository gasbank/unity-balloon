...
public static class LocalizedTextUtil
{
    ...
    public static readonly Dictionary<BalloonLanguageCode, string[]> currencyPostfixListDict =
        new Dictionary<BalloonLanguageCode, string[]>
        {
    ...
    {
        if (Data.instance.IsBigNumberNotationOn &&
            currencyPostfixListDict.TryGetValue(Data.instance.CurrentLanguageCode, out var currencyPostfixList))
