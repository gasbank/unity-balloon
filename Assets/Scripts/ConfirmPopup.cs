...
public class ConfirmPopup : MonoBehaviour
{
        ...
        int autoCloseSec = -1)
    {
        ...
        if (onButton3 != null)
        {
            ...
            claimButtonText.text = button3Text;
        }
        else
        {
    ...
    public void OpenGeneralPopup(string msg, UnityAction onButton1, UnityAction onButton2, UnityAction onButton3,
        string titleText, Header header, string button1Text, string button2Text, string button3Text)
    {
        OpenPopup(msg, onButton1, onButton2, onButton3, titleText, header, button1Text, button2Text, button3Text);
    }

    public void OpenTwoButtonPopup(string msg, UnityAction onButton1, UnityAction onButton2, string titleText,
        string button1Text, string button2Text, Header header = Header.Normal,
        ShowPosition showPosition = ShowPosition.Center, UnityAction onCloseButton = null,
        bool allowTouchEventsOutsidePopup = false)
    {
        OpenPopup(msg, onButton1, onButton2, null, titleText, header, button1Text, button2Text, "", "", "", false, null,
            null, WidthType.Normal, 0, showPosition, onCloseButton, allowTouchEventsOutsidePopup);
    }

    public void OpenYesNoPopup(string msg, UnityAction onYes, UnityAction onNo, string titleText,
        Header header = Header.Normal)
    {
        OpenTwoButtonPopup(msg, onYes, onNo, titleText, "\\예".Localized(), "\\아니요".Localized(), header);
    }

    public void OpenInputFieldPopup(string msg, UnityAction onYes, UnityAction onNo, string titleText, Header header,
    ...
    public void OpenClaimPopup(string msg, string claimButtonText, UnityAction onClaim, string titleText,
        Header header = Header.Normal, int autoCloseSec = -1)
    {
        OpenPopup(msg, null, null, onClaim, titleText, header, "", "", claimButtonText, "", "", false, null, null,
            WidthType.Normal, 0, ShowPosition.Center, null, false, autoCloseSec);
    }
    ...
    public void OpenOneButtonPopup(string msg, UnityAction onYes, string titleText, string confirmText,
        Header header = Header.Normal)
    {
    ...
    public void OpenYesImagePopup(string titleText, Sprite sprite, string msg, string button1Text,
        UnityAction onButton1)
    {
    ...
    public void OpenYesImagePopup(string titleText, Sprite sprite, string msg, string button1Text,
        UnityAction onButton1, Header header = Header.Normal)
    {
        OpenPopup(msg, onButton1, null, null, titleText, header, button1Text, "", "", "", "", false, sprite);
    }

    public void OpenYesNoImagePopup(string titleText, Sprite sprite, string msg, string button1Text, string button2Text,
        UnityAction onButton1, UnityAction onButton2)
    {
        OpenPopup(msg, onButton1, onButton2, null, titleText, Header.Normal, button1Text, button2Text, "", "", "",
            false, sprite);
    }
