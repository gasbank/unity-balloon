...
public class Bootstrap : MonoBehaviour
{
    ...
    static readonly int
        LAST_MANUAL_STAGE_NUMBER = 31; // 손수 만든 마지막 스테이지 번호 (Stage 01 ~ Stage 25). 이 이후부터는 자동 생성된 스테이지를 이용한다.
    ...
    public static string CurrentStageName
    {
        get
        {
            var stagePrefabSpawner = FindObjectOfType<StagePrefabSpawner>();
    ...
    {
        if (GetStageNumber(sceneName, out var result)) return result;
        return 1;
    }
