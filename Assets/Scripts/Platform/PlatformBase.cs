...
public class CloudMetadata {
    public static readonly CloudMetadata Invalid = new CloudMetadata { level = -1, levelExp = -1, gem = -1, riceRate = -1, saveDate = -1 };
    public int level;
    public int levelExp;
...
public interface IPlatformBase {
    ...
    void Login(System.Action<bool, string> onAuthResult);
    // 로그아웃
    void Logout();
    ...
    void GetCloudLastSavedMetadataAsync(System.Action<CloudMetadata> onPeekResult); // ACCOUNT_LEVEL_KEY, ACCOUNT_LEVEL_EXP_KEY, ACCOUNT_GEM_KEY, ACCOUNT_RICE_RATE_KEY, SAVE_DATE_KEY
