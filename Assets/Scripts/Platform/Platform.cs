...
public class Platform
{
    ...
    {
        return string.Format(TextHelper.GetText(v), instance.GetAccountTypeText());
    }

    public static void StartAuthAsync(Action<bool, string> onAuthResult)
    {
    ...
    public static void CloudLoad()
    {
        ...
        if (instance.CheckLoadSavePrecondition(TextHelper.GetText("platform_loading"),
                PlatformSaveUtil.StartLoginAndLoad, PlatformSaveUtil.CancelStartLoginForLoad) == false) return;
    ...
    public static void CloudSave()
    {
        ...
        if (instance.CheckLoadSavePrecondition(TextHelper.GetText("platform_saving"),
                PlatformSaveUtil.StartLoginAndSave, PlatformSaveUtil.CancelStartLoginForSave) == false) return;
                ...
                ConfirmPopup.instance.OpenYesNoPopup(overwriteConfirmMsg, () =>
                {
                    ...
                    if (rollback)
                    {
                        var msgAgain = TextHelper.GetText("platform_save_confirm_popup_rollback_alert") + "\n\n" +
                                       overwriteConfirmMsg;
                        ConfirmPopup.instance.OpenYesNoPopup(msgAgain, instance.ExecuteCloudSave,
