...
public struct ScBigInteger
{
    ...
    public ScBigInteger(BigInteger value)
    {
        this.value = value ^ k;
    }

    public ScBigInteger(string value)
    {
        this.value = BigInteger.Parse(value) ^ k;
    }

    // Implicit conversion from BigInteger to ScBigInteger.
    public static implicit operator ScBigInteger(BigInteger x)
    {
        return new ScBigInteger(x);
    }

    // Implicit conversion from long to ScBigInteger.
    public static implicit operator ScBigInteger(long x)
    {
        return new ScBigInteger(x);
    }

    // Explicit conversion from ScBigInteger to BigInteger.
    public static implicit operator BigInteger(ScBigInteger x)
    {
        return x.value ^ k;
    }

    public static ScBigInteger operator ++(ScBigInteger x)
    {
        x.value = ((ScBigInteger) ((BigInteger) x + 1)).value;
        return x;
    }
    ...
    public static bool operator ==(ScBigInteger x, ScBigInteger y)
    {
        return x.value == y.value;
    }

    public static ScBigInteger operator +(ScBigInteger x, ScBigInteger y)
    {
    ...
    public static implicit operator string(ScBigInteger x)
    {
    ...
    public int CompareTo(ScBigInteger other)
    {
